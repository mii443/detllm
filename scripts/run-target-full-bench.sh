...
usage() {
  cat <<'USAGE'
usage: scripts/run-target-full-bench.sh --model PATH --input /tmp/enwik8 [--out DIR] [--name NAME] [--limit-bytes N] [--limit-tokens N] [--n-ctx N] [--threads N] [--progress-every N] [--encode-only] [--estimate-full-run] [--warmup]
